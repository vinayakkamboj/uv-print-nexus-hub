    ...
    <div className="container-custom py-12">
      ...
      <div className="mt-16 bg-gray-50 p-8 rounded-lg">
        ...
        <div className="flex flex-wrap gap-4">
          <a href="/contact" className="bg-primary hover:bg-primary/90 text-white px-6 py-2 rounded-md transition-colors">
            Contact Us
          </a>
          <a href="/order" className="bg-white border border-primary text-primary hover:bg-gray-50 px-6 py-2 rounded-md transition-colors">
            Request a Quote
          </a>
        </div>
      </div>
